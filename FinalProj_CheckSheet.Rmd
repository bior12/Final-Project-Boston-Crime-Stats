...
(A) .Rmd Line numbers where at least two different data sources are imported:  lines 86-89


(B) .Rmd Line numbers for inspecting data intake:  lines 90-115
...
(A) .Rmd Line number(s) for general data wrangling: 117-140
...
(D) .Rmd Line number(s) for use of regular expressions: 164


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 139, 168-169
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  142, 152, 154, 176

(B) .Rmd Line number(s) for use of multiple aesthetics:  142, 152, 154, 176

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps:  189-195
