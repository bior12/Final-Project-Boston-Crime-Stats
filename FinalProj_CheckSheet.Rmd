...
(A) .Rmd Line numbers where at least two different data sources are imported:  lines 74-81


(B) .Rmd Line numbers for inspecting data intake:  lines 98-103
...
(B) .Rmd Line number(s) for a join operation: 91


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 


(D) .Rmd Line number(s) for use of regular expressions: 90, 138-139


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 171 


(F) .Rmd Line number(s) for use of user-defined functions: 147-150, 170-178


(G) .Rmd Line number(s) for use of loops and/or control flow: 137-141
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 113

(B) .Rmd Line number(s) for use of multiple aesthetics: 111

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps: 158-164
