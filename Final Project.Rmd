...
How have outside factors like weather and time affected the distribution of crime rates of Boston?
...
Based on the 4 heat maps, we can clearly see that the data do not change much over the course of these years. The crime data seem to be pretty centralized in Boston as you can see that the highest amount at 300 is right on Boston.
